...
class Fleet(Base):
    ...
    warehouse_process_status = Column(String(20), nullable=True, default="waiting")
    ...
    fleet_transfer_cost = Column(Float, nullable=True)
    fleet_verify_status = Column(Boolean, nullable=True, default=False)
    train_related = Column(String(50), nullable=True)
    check_by_leader = Column(Boolean, nullable=True, default=False)
